...
#define	freq_x 900
#define freq_y 65
#define	ecg_freq_x 900
#define ecg_freq_y 135
#define brad_x 140
#define brad_y 65
#define tac_x 140
#define tac_y 155
...
pthread_t 	freq_id;
struct task_param 	freq_param, comp_param;
struct sched_param 	freq_par;
pthread_attr_t 	freq_attr;


float 	ecg[duration]; 	//valori dell'ecg
int 	index_in; 	//locazione prossimo dato da inserire
int 	counter_qrs; 	//contatore dei picchi (complessi qrs)
int 	ecg_frequency; 	//frequenza di campionamento dell'ecg


BITMAP 	*freq; 	//bitmap per mostrare la frequenza cardiaca a video
BITMAP 	*ecg_freq; 	//bitmap per mostrare la frequenza dell'ecg a video
...
pthread_mutex_t 	sper; 	//semaforo periodo compute
pthread_mutex_t 	sfecg; 	//semaforo frequenza ecg
